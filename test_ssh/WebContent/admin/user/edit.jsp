      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" action="User_save.action" class="form-horizontal" method="post">
              	<div id="form-wizard-1" class="step">
                <%-- <div class="control-group">
                  <label class="control-label" >ID</label>
                  <div class="controls">
                    <input id="ID" type="text" name="user.ID" value=${ edit_user.ID} />
                  </div>
                </div> --%>
                <div class="control-group">
                  <label class="control-label" >姓名</label>
                  <div class="controls">
                    <input id="username" type="text" name="user.userName" value=${ edit_user.userName} />
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">密码</label>
                  <div class="controls">
                    <input id="password" type="password" name="user.passWord" value=${ edit_user.passWord} />
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">状态</label>
                  <div class="controls">
                    <input id="status" type="text" name="user.status" value=${ edit_user.status} />
                  </div>
                </div>
              </div>
