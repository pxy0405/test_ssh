      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form id="form-wizard" class="form-horizontal" action="category_update.action" method="post">
             <input type="hidden" name="myCid" value="${category.cid }"/>
              <div id="form-wizard-1" class="step">
                <div class="control-group">
                  <label class="control-label">一级目录名字</label>
                  <div class="controls">
                    <input id="pname" type="text" name="category.cname" value="${category.cname }" />
                  </div>
                </div>
                </div>
