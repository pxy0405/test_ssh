...
<link href="${pageContext.request.contextPath}/css/common.css" rel="stylesheet" type="text/css"/>
    ...
    <link type="text/css" href="${pageContext.request.contextPath}/scss/style.css" rel="stylesheet" />
...
<%-- <div class="container productContent">
	...
	<div class="listMain">
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="${pageContext.request.contextPath}/${product.image}" title="pic" />
								</li>
								<li>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="images/01.jpg"><img src="${pageContext.request.contextPath}/${product.image}" alt="细节展示放大镜特效" rel="${pageContext.request.contextPath}/${product.image}" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${pageContext.request.contextPath}/${product.image}" mid="${pageContext.request.contextPath}/${product.image}" big="${pageContext.request.contextPath}/${product.image}"/></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
				...
				<div class="action">
					...
					<!-- <div class="buy">
							<a id="addCart" class="addCart" title="加入购物车" type="button" onclick="saveCart()">加入购物车</a>
					</div> -->
					<li>
...
<script type="text/javascript" src="${pageContext.request.contextPath}js/xiaomi.js"></script>
</body>
</html>