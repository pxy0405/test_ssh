					...
					<form id="registerForm" action="${ pageContext.request.contextPath }/User_register.action"  method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								...
								<td>
									<input type="text" id="userName" name="user.userName" class="text" maxlength="20" onblur="checkUserName(this.value)"/>
									<span id="span1"></span>
								</td>
							</tr>
							<tr>
							...
							<%-- <tr>
								...
								<td>
									...
									<tr>
										...
										<td>
												<input type="text" name="user.phone" class="text" maxlength="200"/>
										</td>
									</tr> --%>
									<tr>
										<th>
										...
										<td>
												<input id="status" type="text" name="user.status" class="text" maxlength="200"/>
										</td>
									</tr>
									<tr>
										<th>
									...
									<!-- <tr>
										...
										<td>
												<input type="text" name="user.code" class="text" onfocus="WdatePicker();"/>
										</td>
									</tr>
...
<div class="container footer">
	<div class="span24">
		<div class="footerAd">
					<img src="${pageContext.request.contextPath}/img/footer.jpg" width="950" height="52" alt="我们的优势" title="我们的优势">
</div>	</div>
	<div class="span24">
		<ul class="bottomNav">
					<li>
